...
function EditItem({ toggleEditItemPage }) {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Updating item:', itemId, formData); // Log the ID and form data
    ...
    <div className="edit-item-container">
      ...
      {selectedItem && (
        <form className="edit-form" onSubmit={handleSubmit}>
          ...
          <label>Count Products Available</label>
          <input type="number" name="count_products_available" value={formData.count_products_available} onChange={handleChange} />
